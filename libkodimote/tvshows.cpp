...
TvShows::TvShows(KodiModel *parent) :
    KodiLibrary(parent),
    m_refreshing(false)
{
...
void TvShows::receivedAnnouncement(const QVariantMap &map)
{
    ...
    KodiConnection::sendCommand("VideoLibrary.GetTVShows", params, this, "playcountReceived");
    m_refreshing = true;
}
...
void TvShows::refresh()
{
    ...
    KodiConnection::sendCommand("VideoLibrary.GetTVShows", params, this, "showsReceived");
    m_refreshing = true;
}
...
//    properties.append("episodeguide");
    ...
    int id = KodiConnection::sendCommand("VideoLibrary.GetTVShowDetails", params, this, "showDetailsReceived");
...
KodiModel *TvShows::enterItem(int index)
{
